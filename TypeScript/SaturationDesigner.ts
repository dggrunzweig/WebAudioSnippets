...
export function HyperTanDistortionCurve(
    ceiling_dB = 0, boost_dB = 3, curve_size = 512): Float32Array {
...
export function HardClipCurve(
    ceiling_dB = 0, boost_dB = 0, curve_size = 512): Float32Array {
  const curve = new Float32Array(curve_size);
...
export function BitCrushCurve(bit_depth = 32, curve_size = 512): Float32Array {
  const curve = new Float32Array(curve_size);
